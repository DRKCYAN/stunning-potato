export type EligStatus = 'yes' | 'no' | 'conditional' | 'varies';
...
export interface CollegeTopicConfig {
  visa: string;
  visaLabel: string;
  state: string;
  stateCode: string;
  inStateTuitionEligible: EligStatus;
  canApplyToPublicUniversities: EligStatus;
  canReceiveStateFinancialAid: EligStatus;
  wikiArticles: string[];
  sectionsToShow: string[];
  govSources: GovSource[];
}

const SHARED_WIKI_SECTIONS = [
  'Overview', 'History', 'Background', 'Education', 'Eligibility',
  'Benefits', 'Criticism', 'Legal status', 'Policy', 'Definition',
  'Requirements', 'Application', 'Tuition', 'Financial aid',
];

const CONFIGS: CollegeTopicConfig[] = [
  // ── DACA ────────────────────────────────────────────────────────────────────
  {
    visa: 'daca', visaLabel: 'DACA Recipient', state: 'California', stateCode: 'CA',
  ...
  {
    visa: 'daca', visaLabel: 'DACA Recipient', state: 'New York', stateCode: 'NY',
  ...
  {
    visa: 'daca', visaLabel: 'DACA Recipient', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  // ── F-2 ─────────────────────────────────────────────────────────────────────
  {
    visa: 'f2', visaLabel: 'F-2 Dependent', state: 'California', stateCode: 'CA',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  {
    visa: 'f2', visaLabel: 'F-2 Dependent', state: 'New York', stateCode: 'NY',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  {
    visa: 'f2', visaLabel: 'F-2 Dependent', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  // ── H-4 ─────────────────────────────────────────────────────────────────────
  {
    visa: 'h4', visaLabel: 'H-4 Dependent', state: 'California', stateCode: 'CA',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
  ...
  {
    visa: 'h4', visaLabel: 'H-4 Dependent', state: 'New York', stateCode: 'NY',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  {
    visa: 'h4', visaLabel: 'H-4 Dependent', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  // ── F-1 ─────────────────────────────────────────────────────────────────────
  {
    visa: 'f1', visaLabel: 'F-1 Student', state: 'California', stateCode: 'CA',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'no',
  ...
  {
    visa: 'f1', visaLabel: 'F-1 Student', state: 'New York', stateCode: 'NY',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  {
    visa: 'f1', visaLabel: 'F-1 Student', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  // ── Undocumented ─────────────────────────────────────────────────────────────
  {
    visa: 'undocumented', visaLabel: 'Undocumented', state: 'California', stateCode: 'CA',
    inStateTuitionEligible: 'yes',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'yes',
  ...
  {
    visa: 'undocumented', visaLabel: 'Undocumented', state: 'New York', stateCode: 'NY',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  {
    visa: 'undocumented', visaLabel: 'Undocumented', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'conditional',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'conditional',
  ...
  // ── Asylum ───────────────────────────────────────────────────────────────────
  {
    visa: 'asylum', visaLabel: 'Asylum Seeker / Asylee', state: 'California', stateCode: 'CA',
    inStateTuitionEligible: 'yes',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'yes',
  ...
  {
    visa: 'asylum', visaLabel: 'Asylum Seeker / Asylee', state: 'New York', stateCode: 'NY',
    inStateTuitionEligible: 'yes',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'yes',
    wikiArticles: ['Asylum in the United States', 'Refugee', 'Federal Student Aid'],
  ...
  {
    visa: 'asylum', visaLabel: 'Asylum Seeker / Asylee', state: 'Texas', stateCode: 'TX',
    inStateTuitionEligible: 'yes',
    canApplyToPublicUniversities: 'yes',
    canReceiveStateFinancialAid: 'yes',
    wikiArticles: ['Asylum in the United States', 'Refugee', 'Federal Student Aid'],
...
// Build a lookup map: "visa:stateCode" → config
export const COLLEGE_TOPICS: Map<string, CollegeTopicConfig> = new Map(
  CONFIGS.map(c => [`${c.visa}:${c.stateCode}`, c])
);

export function getCollegeTopic(visa: string, stateCode: string): CollegeTopicConfig | undefined {
  return COLLEGE_TOPICS.get(`${visa}:${stateCode}`);
}

export function getAllCollegeTopics(): CollegeTopicConfig[] {
  return CONFIGS;
}
